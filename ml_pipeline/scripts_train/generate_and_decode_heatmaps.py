...
dataset_path = Path("/Users/hegedusrazvan/Developer/Faculty/IOTCA/CatPlayground/ml_pipeline/dataset/crop")
image_paths = dataset_path.glob("*.png")
image_paths_10 = [img for img in image_paths][:10]


dataset_json_path = Path("/Users/hegedusrazvan/Developer/Faculty/IOTCA/CatPlayground/ml_pipeline/dataset/json_labels")
